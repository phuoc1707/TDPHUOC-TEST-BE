...
@Validated
public abstract class GenericController<ID, I, O> {
    ...
    public ResponseEntity<SingleResponse<O>> getResource(@PathVariable("id") ID id) {
    ...
    public ResponseEntity<SingleResponse<O>> updateResource(@PathVariable("id") ID id, @RequestBody @Valid I request) {
    ...
    public ResponseEntity<Void> deleteResource(@PathVariable("id") ID id) {
        service.delete(id);
